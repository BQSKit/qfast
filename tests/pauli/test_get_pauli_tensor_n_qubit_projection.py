...
from qfast import get_pauli_tensor_n_qubit_projection, reset_tensor_cache


class TestGetPauliTensorNQubitProjection ( tf.test.TestCase ):
    ...
    def test_get_pauli_tensor_tensor_1_qubit_proj_n1 ( self ):
        num_qubits = -1
        self.assertRaises( ValueError, get_pauli_tensor_n_qubit_projection, num_qubits, [2] )

    def test_get_pauli_tensor_1_qubit_proj_o1 ( self ):
        num_qubits = 5
        self.assertRaises( ValueError, get_pauli_tensor_n_qubit_projection, num_qubits, [6] )

    def test_get_pauli_tensor_1_qubit_proj_q1 ( self ):
        num_qubits = 5
        self.assertRaises( ValueError, get_pauli_tensor_n_qubit_projection, num_qubits, [-1] )

    def test_get_pauli_tensor_1_qubit_proj_3_0 ( self ):
        num_qubits = 3
        qubit_proj = 0
        reset_tensor_cache()
    ...
    def test_get_pauli_tensor_1_qubit_proj_3_1 ( self ):
        num_qubits = 3
        qubit_proj = 1
        reset_tensor_cache()
        tensors = get_pauli_tensor_n_qubit_projection( num_qubits, [ qubit_proj ] )
    ...
    def test_get_pauli_tensor_1_qubit_proj_3_2 ( self ):
        num_qubits = 3
        qubit_proj = 2
        reset_tensor_cache()
        tensors = get_pauli_tensor_n_qubit_projection( num_qubits, [ qubit_proj ] )
    ...
    def test_get_pauli_tensor_1_qubit_proj_4_1 ( self ):
        num_qubits = 4
        qubit_proj = 1
        reset_tensor_cache()
        tensors = get_pauli_tensor_n_qubit_projection( num_qubits, [ qubit_proj ] )
    ...
    def test_get_pauli_tensor_1_qubit_proj_4_2 ( self ):
        num_qubits = 4
        qubit_proj = 2
        reset_tensor_cache()
        tensors = get_pauli_tensor_n_qubit_projection( num_qubits, [ qubit_proj ] )
    ...
    def test_get_pauli_tensor_1_qubit_proj_4_3 ( self ):
        num_qubits = 4
        qubit_proj = 3
        reset_tensor_cache()
        tensors = get_pauli_tensor_n_qubit_projection( num_qubits, [ qubit_proj ] )
    ...
    def test_get_pauli_tensor_2_qubit_proj_n1 ( self ):
        num_qubits = -1
        self.assertRaises( ValueError, get_pauli_tensor_n_qubit_projection, num_qubits, [2, 3] )

    def test_get_pauli_tensor_2_qubit_proj_o1 ( self ):
        num_qubits = 5
        self.assertRaises( ValueError, get_pauli_tensor_n_qubit_projection, num_qubits, [6, 1] )

    def test_get_pauli_tensor_2_qubit_proj_q1 ( self ):
        num_qubits = 5
        self.assertRaises( ValueError, get_pauli_tensor_n_qubit_projection, num_qubits, [-1, 1] )

    def test_get_pauli_tensor_2_qubit_proj_2o1 ( self ):
        num_qubits = 5
        self.assertRaises( ValueError, get_pauli_tensor_n_qubit_projection, num_qubits, [1, 6] )

    def test_get_pauli_tensor_2_qubit_proj_2q1 ( self ):
        num_qubits = 5
        self.assertRaises( ValueError, get_pauli_tensor_n_qubit_projection, num_qubits, [1, -1] )

    def test_get_pauli_tensor_2_qubit_proj_q0eq1 ( self ):
        num_qubits = 5
        self.assertRaises( ValueError, get_pauli_tensor_n_qubit_projection, num_qubits, [1, 1] )

    def test_get_pauli_tensor_2_qubit_proj_3_0_1 ( self ):
        num_qubits = 3
        qubit_pro1 = 0
        qubit_pro2 = 1
        reset_tensor_cache()
    ...
    def test_get_pauli_tensor_2_qubit_proj_3_0_2 ( self ):
        num_qubits = 3
        qubit_pro1 = 0
        qubit_pro2 = 2
        reset_tensor_cache()
    ...
    def test_get_pauli_tensor_2_qubit_proj_4_0_2 ( self ):
        num_qubits = 4
        qubit_pro1 = 0
        qubit_pro2 = 2
        reset_tensor_cache()
